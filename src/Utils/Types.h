...
#include <vector>
#include <array>
enum Types {pad,strip,stripup,stripdown,temporal,tcherenkov,tricot,scintillator,bif,m3};
const std::vector<std::string>Types_Dif{"Pad","Strip","StripUp","StripDown","Temporal","Tcherenkov","Tricot","Scintillator","BIF","M3"};
